  ...
  $("#form_login_signup").click(function () {
    let signUpHtml = `
      ...
      <div class="form-group">
        ...
        <input type="password" class="form-control" id="signUpPassword2" placeholder="Enter Pasword Again">
      </div>
      ...
      <a href="../landing.html">
        <div type="submit" class="btn btn-primary" id="signUpSubmit">Sign Up</div>
      </a>`;
